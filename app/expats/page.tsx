...
const ExpatsApplicationPage = () => {
  ...
  const sections: Section[] = expatData as Section[];
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
          <div className="bg-white p-8 md:p-12 rounded-lg shadow-lg text-center space-y-6">
            ...
            <p className="text-lg text-gray-600">
              Thank you for submitting your Expats application. We will review
      ...
      <div className="min-h-screen">
        <div className="container mx-auto px-4 py-8 md:py-12">
                ...
                {sortedSections.map((section, index) => (
                  <React.Fragment key={section.id}>
                    ...
                    <div className="flex flex-col items-center relative z-10">
                      ...
                      {/* Step Label */}
                      <div className="mt-3 text-center max-w-[100px] md:max-w-[140px]">
                        <p
                    ...
                    {index < sortedSections.length - 1 && (
                      <div className="flex-1 h-1 mx-2 relative -top-5 md:-top-5">
                        <div
          ...
          <Tabs 
            ...
            className="w-full"
          >
            <TabsList className="w-full justify-start mb-6 bg-white shadow-md p-1 flex-wrap h-auto">
              {sortedSubSections.map((subSection, index) => (
                <TabsTrigger
                  key={subSection.id}
                  value={index.toString()}
                  className="cursor-pointer data-[state=active]:bg-red-600 data-[state=active]:text-white text-sm"
                >
